...
// Iraqi-Syrian Conflict - Islamic State (@CBA_A3;@ISC;@cup_weapons;@mas_nato_rus_sf_veh;@rhs_afrf3;@rhs_usf3)
	...
	_p addItemToUniform "FirstAidKit";
	_p addItemToUniform "CUP_30Rnd_Sa58_M_TracerG";
	for "_i" from 1 to 3 do {_p addItemToUniform "CUP_1Rnd_SmokeRed_M203";};
	_p addItemToUniform "CUP_HandGrenade_M67";

	_p addVest "SP_OpforRig1_Tan";
	for "_i" from 1 to 4 do {_p addItemToVest "CUP_30Rnd_Sa58_M_TracerG";};
	for "_i" from 1 to 3 do {_p addItemToVest "CUP_30Rnd_9x19_UZI";};
	_p addItemToVest "CUP_30Rnd_Sa58_M_TracerR";

	_p addBackpack "CUP_B_USPack_Coyote";
	for "_i" from 1 to 3 do {_p addItemToBackpack "FirstAidKit";};
	for "_i" from 1 to 3 do {_p addItemToBackpack "CUP_1Rnd_HE_M203";};
	for "_i" from 1 to 2 do {_p addItemToBackpack "CUP_1Rnd_HEDP_M203";};
	for "_i" from 1 to 2 do {_p addItemToBackpack "Chemlight_blue";};
	for "_i" from 1 to 2 do {_p addItemToBackpack "CUP_HandGrenade_M67";};
	_p addItemToBackpack "CUP_IED_V2_M";
	for "_i" from 1 to 2 do {_p addItemToBackpack "APERSBoundingMine_Range_Mag";};
	_p addItemToBackpack "APERSTripMine_Wire_Mag";
	for "_i" from 1 to 3 do {_p addItemToBackpack "CUP_30Rnd_Sa58_M_TracerG";};

	_p addHeadgear "H_ShemagOpen_tan";

	[_p,"CUP_arifle_Sa58RIS2_gl",1] call BIS_fnc_AddWeapon;
	_p addPrimaryWeaponItem "CUP_acc_ANPEQ_2";
	_p addPrimaryWeaponItem "CUP_optic_ACOG";
	[_p,"CUP_hgun_MicroUzi",1] call BIS_fnc_AddWeapon;
