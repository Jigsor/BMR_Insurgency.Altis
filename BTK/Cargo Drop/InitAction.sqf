...
_CargoAction = _Transporter addAction [("<t size='1.5' shadow='2' color='#12F905'>" + (localize "STR_BMR_load_cargo") + "</t>"),"BTK\Cargo Drop\Engine.sqf",["LoadCargo"], 5, false, false, "", "vehicle _this == player"];
