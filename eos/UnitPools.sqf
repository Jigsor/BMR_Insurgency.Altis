...
switch (_faction) do {
	...
	case 5: {// Massi Africian Rebel Army (EAST)
	...
	case 6: {// Massi Armed African Civilians (Rebel supporters EAST)
	...
	case 8: {// Massi Middle East Insurgents (EAST)
	...
	case 9: {// Massi Takistan Army (EAST)
	...
	case 10: {// Massi Takistan Insurgents (EAST)
	...
	case 11: {// Leight's Opfor Pack - Islamic State of Takistan and Sahrani
	...
	case 12: {// Leight's Opfor Pack - Afghan militia
	...
	case 15: {// RHS - Armed Forces of the Russian Federation MSV
	...
	case 16: {// RHS GREF - Chenarus Ground Forces (RESISTANCE)
	...
	case 17: {// RHS GREF - Nationalist Troops (RESISTANCE)
	...
	case 18: {// ISC - Syrian Arab Army (Opfor)
	...
	case 19: {// ISC - Islamic State (Opfor)
