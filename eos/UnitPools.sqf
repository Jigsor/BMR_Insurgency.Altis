...
switch (_faction) do {
	...
	case 4: {// Massi Africian Rebel Army (EAST)
	...
	case 5: {// Massi Armed African Civilians (Rebel supporters EAST)
	...
	case 7: {// Massi Middle East Insurgents (EAST)
	...
	case 8: {// Massi Takistan Army (EAST)
	...
	case 9: {// Massi Takistan Insurgents (EAST)
	...
	case 15: {// RHS GREF - Chenarus Ground Forces (RESISTANCE)
	...
	case 16: {// RHS GREF - Nationalist Troops (RESISTANCE)
	...
	case 17: {// ISC - Syrian Arab Army (Opfor)
	...
	case 18: {// ISC - Islamic State (Opfor)
